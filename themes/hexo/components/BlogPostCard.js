    ...
    >
      ...
      >
        ...
        <div
          ...
          } flex-wrap dark:text-gray-500 text-gray-400 hover:text-amber-500 dark:hover:text-amber-500`}
        >
          <Link
        ...
        <div className="text-gray-400 justify-between flex">
          <Link
            ...
            passHref
            className="cursor-pointer font-light text-sm hover:underline hover:text-amber-700 dark:hover:text-amber-400 transform"
          >
