...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '4ed8ee636cc44dd381c2d528046424c6',
  ...
  AUTHOR: 'Wave52', // 您的昵称 例如 tangly1024
  BIO: '打工人🧎🏻', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://vercel.wuchengran.com', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: '7003397@qq.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: 'https://twitter.com/Wave52_', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/wave52', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  BACKGROUND_DARK: '#222222', // use hex value, don't forget '#'
